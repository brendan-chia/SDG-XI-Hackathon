...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative flex min-h-[70vh] flex-col items-center justify-center space-y-8 overflow-hidden text-center">
        {/* Background image */}
        ...
        {/* Content */}
        <div className="container relative z-10 flex flex-col items-center space-y-8">
          <div className="space-y-4 text-white">
            <p className="text-sm font-semibold tracking-[0.2em] uppercase text-primary-200/90">
              Smarter Solar, Made Simple
            </p>
            <h1 className="text-5xl font-bold tracking-tight sm:text-6xl">
              Solar Potential Estimator
            </h1>
            <p className="mx-auto max-w-[700px] text-xl text-primary-50/90">
              Discover your roof&apos;s solar potential and estimate your energy savings.
              Enter your address, visualize shade, and see ROI projections in minutes.
            </p>
          </div>
          <Button
            size="lg"
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="space-y-2 text-center">
              ...
              <p className="text-muted-foreground">
                Enter your address for satellite view
              </p>
            </div>
            <div className="space-y-2 text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground text-xl font-bold">
